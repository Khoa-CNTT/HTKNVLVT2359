...
let sendmail = (note, userMail, link = null) => {
    ...
    if (link)
    {
        ...
        // <i> - xem thông tin bài viết <a href='${process.env.URL_REACT}/${link}'>Tại đây</a></i> `
    }
                    ...
                    if (company.statusCode == "S1") {
                        if (data.isHot == '1') {
                            if (company.allowHotPost > 0) {
                                ...
                                resolve({
                                    errCode: 2,
                                    errMessage: 'Công ty bạn hiện tại không có lượt đăng bài viết nổi bật'
                                })
                                return
                            }
                        }
            ...
            if (!data.postId || !data.note || !data.userId) {
                ...
                if (foundPost) {
                    ...
                    sendmail(`  <img width="50%" src="https://www.findjobs.vn//htdocs/images/employers/202202/find_cam_job_xam.png" alt='logo' />
                                ...
                                <h3><i>Bài Tuyển Dụng : ${postName.name} Của Bạn Đã Bị Chặn</i></h3>
                                <p> - Vì Lí Do : ${data.note}</p>
                                <p> - Trân Trọng</p>`, user.email,`admin/list-post/${foundPost.id}`)
        ...
        try {
            ...
            if (!data.id || !data.userId || !data.note) {
                ...
                if (foundPost) {
                    ...
                    sendmail(`  <img width="50%" src="https://www.findjobs.vn//htdocs/images/employers/202202/find_cam_job_xam.png" alt='logo' />
                                <h1>FIND JOBS Xin Thông Báo Tới Bạn</h1>
                                <h3><i>Bài Tuyển Dụng : ${postName.name} Của Bạn Đã Được Mở Lại</i></h3>
                                <p> - Vì Lí Do : ${data.note}</p>
                                <p> - Trân Trọng</p>
                                `, user.email,`admin/list-post/${foundPost.id}`)
                    resolve({
                        errCode: 0,
            ...
            if (!data.id || !data.statusCode) {
                ...
                if (foundPost) {
                    ...
                    if (data.statusCode == "PS1")
                    {
                        sendmail(`  <img width="50%" src="https://www.findjobs.vn//htdocs/images/employers/202202/find_cam_job_xam.png" alt='logo' />
                                    <h1>FIND JOBS Xin Thông Báo Tới Bạn</h1>
                                    <h3><i>Bài Tuyển Dụng : ${postName.name} Của Bạn Đã Được Duyệt Thành Công</i></h3>
                                    <p> - Hãy Cùng Tìm Kiếm Ứng Viên Phù Hợp Với Công Ty Của Bạn </p>
                                    <p> - Trân Trọng</p>`, user.email,`detail-job/${foundPost.id}`)
                    }
                    else {
                        sendmail(`  <img width="50%" src="https://www.findjobs.vn//htdocs/images/employers/202202/find_cam_job_xam.png" alt='logo' />
                                    <h1>FIND JOBS Xin Thông Báo Tới Bạn</h1>
                                    <h3><i>Bài Tuyển Dụng : ${postName.name} Của Bạn Đã Bị Từ Chối</i></h3
                                    <p> - Vì Lí Do : ${note}</p>
                                    <p> - Trân Trọng</p>`, user.email,`admin/list-post/${foundPost.id}`)
                    }
                    resolve({
