...
const DetailCompany = () => {
  ...
  return (
    <div
      style={{ backgroundColor: "#e2ebf8" }}
      className="container-detail-company"
    >
          ...
          <div className="company-detail-overview">
            ...
            <div className="company-info">
              ...
              <div className="d-flex">
                <p className="website">
                  ...
                  <a href={dataCompany.website} target="_blank">
                    {dataCompany.website}
                  </a>
                </p>
            ...
            <div className="box-follow">
              <a
                style={{
                  background:
                    dataCompany.censorData &&
                    (dataCompany.censorData.code === "CS2"
                      ? "yellow"
                      : dataCompany.censorData.code !== "CS1"
                      ? "red"
                      : ""),
                  color: "black",
                }}
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8">
              <div
                style={{ borderRadius: "20px", padding: "0px 0px" }}
                className="company-info box-white"
              >
                <h4
                  style={{
              ...
              <div
                style={{ borderRadius: "20px", padding: "0px 0px" }}
                className="job-listing box-white"
              >
                <h4
                  style={{
                    borderRadius: "20px 20px 0px 0px",
                    ...
                    dataCompany.postData.map((item, index) => {
                      return (
                        ...
                        >
                          <div
                            key={index}
                            className="job-item  job-ta result-job-hover"
                          >
                            <div className="avatar">
                              <img
                                ...
                                className="w-100"
                                alt="Công ty Cổ phần Tập đoàn Hoa Sen"
                                title="Nhân Viên Tuyển Dụng - Đào Tạo"
                              />
                            </div>
                            <div className="body">
                              <div className="content">
                                  ...
                                  <h4 className="title-job">
                                    ...
                                    >
                                      <span
                                        ...
                                        data-placement="top"
                                        data-container="body"
                                        data-original-title="Nhân Viên Tuyển Dụng - Đào Tạo"
                                      >
                                      ...
                                      <i
                                        ...
                                        data-placement="top"
                                        data-container="body"
                                        data-original-title="Tin từ nhà tuyển dụng đã xác thực"
                                      />
                                    </Link>
                                  </h4>
                                </div>
                                ...
                                >
                                  <p className="deadline">
                                    {CommonUtils.formatDate(item.timeEnd) <=
                                    0 ? (
                              ...
                              >
                                <div className="label-content ml-auto">
                                  <label className="salary">
                                    {
                                      item.postDetailData.salaryTypePostData
                                        .value
                                    }
                                  </label>
                                  <label
            ...
            <div className="col-md-4">
              <div
                style={{ borderRadius: "20px", padding: "0px 0px" }}
                className="box-address box-white"
              >
                <h4
                  style={{
                    borderRadius: "20px 20px 0px 0px",
              ...
              <div
                style={{ borderRadius: "20px", padding: "0px 0px" }}
                className="box-sharing box-white"
              >
                <h4 style={{
                    borderRadius: "20px 20px 0px 0px",
                    padding: "20px",
                    ...
                    fontSize: "18px",
                    fontWeight: "bold",
                  }}><i>Chia sẻ công ty tới bạn bè</i></h4>
                <div style={{ padding: "0px 20px 20px 20px" }} className="box-body">
                  ...
                  <div className="box-share">
                    <a
                      href="http://www.facebook.com/sharer/sharer.php?u=https://www.topcv.vn/cong-ty/cong-ty-co-phan-tap-doan-hoa-sen/8734.html"
                      target="_blank"
                    >
                      <img
                    ...
                    <a
                      href="https://twitter.com/intent/tweet?url=https://www.topcv.vn/cong-ty/cong-ty-co-phan-tap-doan-hoa-sen/8734.html"
                      target="_blank"
                    >
                      <img
                    ...
                    <a
                      href="https://www.linkedin.com/cws/share?url=https://www.topcv.vn/cong-ty/cong-ty-co-phan-tap-doan-hoa-sen/8734.html"
                      target="_blank"
                    >
                      <img
