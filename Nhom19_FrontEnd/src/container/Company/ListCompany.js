...
const ListCompany = () => {
    ...
    return (
        <div
            style={{ backgroundColor: "#e2ebf8", padding: "50px 0px" }}
            className="container-company"
        >
            <h3 style={{ margin: "0px 0px" }} className="title">
                <i>DANH SÁCH CÁC CÔNG TY</i>
            </h3>
            <div className="row list-company">
                <span>
                    <i>{countData} công ty được tìm thấy</i>
                </span>
                <Input.Search
