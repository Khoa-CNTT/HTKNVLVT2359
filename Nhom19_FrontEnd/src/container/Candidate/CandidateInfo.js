                                ...
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <input style={{borderRadius : '20px'}} type="text" value={inputValues.firstName} name="firstName" onChange={(event) => handleOnChange(event)} className="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <input style={{borderRadius : '20px'}} type="text" value={inputValues.lastName} name="lastName" onChange={(event) => handleOnChange(event)} className="form-control" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <input style={{borderRadius : '20px'}} type="text" value={inputValues.address} name="address" onChange={(event) => handleOnChange(event)} className="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <input style={{borderRadius : '20px'}} type="number" value={inputValues.phonenumber} disabled={isActionADD === true ? false : true} name="phonenumber" onChange={(event) => handleOnChange(event)} className="form-control" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <select  style={{borderRadius : '20px' , color : 'black'}} className="form-control" value={inputValues.genderCode} name="genderCode" onChange={(event) => handleOnChange(event)}>
                                ...
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <DatePicker style={{borderRadius : '20px'}} className="form-control" onChange={handleOnChangeDatePicker}
                                                value={birthday}
                                            />
                                        </div>
                                    </div>
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <input style={{borderRadius : '20px'}} accept='image/*' onChange={(event) => handleOnChangeImage(event)} type="file" className="form-control form-file" />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <div style={{ backgroundImage: `url(${inputValues.imageReview})` , borderRadius : '20px' }} onClick={() => openPreviewImage()} className="box-img-preview"></div>
                                        </div>
                                    </div>
                                </div>
