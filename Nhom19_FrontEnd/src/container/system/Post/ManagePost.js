...
const ManagePost = () => {
  ...
  const [censorCode, setCensorCode] = useState("PS1");
            ...
            <Row justify="space-around" className="mt-5 mb-5">
              ...
              <Col xs={8} xxl={8}>
                ...
                <Select
                  ...
                  size="default"
                  defaultValue={
                    id ? censorOptions[0].value : censorOptions[0].value
                  }
              ...
              <table className="table table-bordered">
                <thead>
                  <tr>
                    ...
                    <th>Mã bài đăng</th>
                    <th>Tên bài đăng</th>
                    {user?.roleCode === "ADMIN" && <th>Tên công ty</th>}
                      ...
                      return (
                        <tr key={index}>
                          ...
                          <td>
                            <label
                              className={
                                item.statusPostData.code == "PS1"
                                  ? "badge badge-success"
                                  : item.statusPostData.code == "PS3"
                                  ? "badge badge-warning"
                                  : "badge badge-danger"
                              }
                            >
                              {item.statusPostData.value}
                            </label>
                          </td>
                          ...
                          <td>
                            ...
                            {(user.roleCode == "COMPANY" ||
                              user.roleCode == "EMPLOYER") && (
                              <>
                                <Link
                                  style={{ color: "#4B49AC" }}
                                  to={`/admin/list-cv/${item.id}/`}
                                >
                                  <span className="btn_update">Xem CV nộp</span>
                                </Link>
                                &nbsp; &nbsp;
                              </>
                            )}
