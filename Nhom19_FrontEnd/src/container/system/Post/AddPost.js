                ...
                <div className="col-12 grid-margin">
                    <div style={{padding : '30px' , borderRadius : '30px'}} className="card">
                        <div className="card-body">
                            ...
                            <h4 style={{marginTop : '25px'}} className="card-title"><i>{inputValues.isActionADD === true ? 'Tạo mới bài đăng' :(user?.roleCode === 'ADMIN' ? 'Xem thông tin bài đăng' : 'Cập nhật bài đăng')}</i></h4>
                            <br></br>
                            ...
                            <form className="form-sample">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <input style={{borderRadius : '30px'}} disabled={user?.roleCode === "ADMIN" ? true : false} value={inputValues.name} name="name" onChange={(event) => handleOnChange(event)} type="text" className="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <select disabled={user?.roleCode === "ADMIN" ? true : false} style={{ color: "black" , borderRadius : '30px' }} className="form-control" value={inputValues.addressCode} name="addressCode" onChange={(event) => handleOnChange(event)}>
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <input style={{borderRadius : '30px'}} disabled={user?.roleCode === "ADMIN" ? true : false} value={inputValues.amount} name="amount" onChange={(event) => handleOnChange(event)} type="number" className="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <DatePicker style={{borderRadius : '30px'}} disabled={!inputValues.isActionADD} dis className="form-control" onChange={handleOnChangeDatePicker}
                                                    value={timeEnd}
                                                />
                                            </div>
                                        </div>
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <select style={{borderRadius : '30px' , color: "black"}} disabled={user?.roleCode === "ADMIN" ? true : false} className="form-control" value={inputValues.genderCode} name="genderCode" onChange={(event) => handleOnChange(event)}>
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <select style={{borderRadius : '30px' , color: "black"}} disabled={user?.roleCode === "ADMIN" ? true : false} className="form-control" value={inputValues.experienceJobCode} name="experienceJobCode" onChange={(event) => handleOnChange(event)}>
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <select style={{borderRadius : '30px' , color: "black"}} disabled={user?.roleCode === "ADMIN" ? true : false} className="form-control" value={inputValues.categoryJobCode} name="categoryJobCode" onChange={(event) => handleOnChange(event)}>
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <select style={{borderRadius : '30px' , color: "black"}} disabled={user?.roleCode === "ADMIN" ? true : false} className="form-control" value={inputValues.categoryJoblevelCode} name="categoryJoblevelCode" onChange={(event) => handleOnChange(event)}>
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <select style={{borderRadius : '30px' , color: "black"}} disabled={user?.roleCode === "ADMIN" ? true : false} className="form-control" value={inputValues.salaryJobCode} name="salaryJobCode" onChange={(event) => handleOnChange(event)}>
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <select style={{borderRadius : '30px' , color: "black"}} disabled={user?.roleCode === "ADMIN" ? true : false} className="form-control" value={inputValues.categoryWorktypeCode} name="categoryWorktypeCode" onChange={(event) => handleOnChange(event)}>
                                    ...
                                    <div className='row'>
                                        <div className="col-md-6">
                                            <div className="form-group row">
                                                ...
                                                <div className="col-sm-9">
                                                    <input style={{borderRadius : '30px' , marginTop: '20px'}} disabled={user?.roleCode === "ADMIN" ? true : false} onChange={handleIsHot} checked={inputValues.isHot} type={'checkbox'}></input>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                </div>
                                {
                                        user.roleCode !== "ADMIN" &&
                                        <>
                                            <button style={{backgroundColor : 'rgb(250 166 26)' , border : '1px solid rgb(250 166 26)'}} onClick={() => handleSavePost()} type="button" className="btn1 btn1-primary1 btn1-icon-text">
