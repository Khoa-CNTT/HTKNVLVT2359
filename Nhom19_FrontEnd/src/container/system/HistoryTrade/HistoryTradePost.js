                ...
                <div className="col-12 grid-margin">
                    <div style={{padding : '30px' , borderRadius : '30px'}} className="card">
                        <div className="card-body">
                            <h4 className="card-title"><i>Lịch sử thanh toán các gói bài đăng</i></h4>
                            <button  style={{float:'right' , borderRadius : '30px'}} onClick={() => handleOnClickExport()} >Xuất excel <i class="fa-solid fa-file-excel"></i></button>
                            <RangePicker style={{borderRadius : '30px'}} onChange={onDatePicker}
                                format={'DD/MM/YYYY'}
                            ></RangePicker>


                            <div style={{marginTop : '30px'}} className="table-responsive pt-2">
                                            ...
                                            data.map((item, index) => {
                                                ...
                                                return (
                                                    <tr key={index}>
                                                        ...
                                                        <td>{item.amount}</td>
                                                        <td style={{ textAlign: 'right' }}>{(item.packageOrderData.price * 1000000).toLocaleString('vi-VN')} VNĐ</td>
