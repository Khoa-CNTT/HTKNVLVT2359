                ...
                <div className="col-12 grid-margin">
                    <div style={{padding : '30px' , borderRadius : '30px'}} className="card">
                        <div className="card-body">
                            ...
                            <h4 style={{marginTop : '25px'}} className="card-title"><i>{inputValues.isActionADD === true ? 'Tạo mới công ty' : (user?.roleCode === 'ADMIN' ? 'Xem thông tin công ty' : 'Cập nhật công ty')}</i></h4>
                            <br></br>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <input style={{borderRadius : '30px'}} disabled={user?.roleCode === "ADMIN" ? true : false} value={inputValues.phonenumber} name="phonenumber" onChange={(event) => handleOnChange(event)} type="number" className="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <input style={{borderRadius : '30px'}} disabled={user?.roleCode === "ADMIN" ? true : false} value={inputValues.taxnumber} name="taxnumber" onChange={(event) => handleOnChange(event)} type="text" className="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <input style={{borderRadius : '30px'}} disabled={user?.roleCode === "ADMIN" ? true : false} value={inputValues.amountEmployer} name="amountEmployer" onChange={(event) => handleOnChange(event)} type="number" className="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <input style={{borderRadius : '30px'}} disabled={user?.roleCode === "ADMIN" ? true : false} value={inputValues.address} name="address" onChange={(event) => handleOnChange(event)} type="text" className="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <input style={{borderRadius : '30px'}} disabled={user?.roleCode === "ADMIN" ? true : false} value={inputValues.website} name="website" onChange={(event) => handleOnChange(event)} type="text" className="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <input style={{borderRadius : '30px'}} disabled={user?.roleCode === "ADMIN" ? true : false} name='image' onChange={(event) => handleOnChangeImage(event)} accept='image/*' type="file" className="form-control form-file" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <div name='review' style={{ backgroundImage: `url(${inputValues.imageReview})` , borderRadius : '30px' }} onClick={(event) => openPreviewImage(event)} className="box-img-preview"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <input style={{borderRadius : '30px'}} disabled={user?.roleCode === "ADMIN" ? true : false} name='coverImage' onChange={(event) => handleOnChangeImage(event)} accept='image/*' type="file" className="form-control form-file" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            <label className="col-sm-3 col-form-label">Hiển thị</label>
                                            <div className="col-sm-9">
                                                <div name='cover' style={{ backgroundImage: `url(${inputValues.coverImageReview})` , borderRadius : '30px' }} onClick={(event) => openPreviewImage(event)} className="box-img-preview"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
