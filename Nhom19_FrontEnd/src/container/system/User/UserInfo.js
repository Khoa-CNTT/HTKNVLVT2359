    ...
    return (
        <div className=''>
            <div className="col-12 grid-margin">
                <div style={{padding : '30px' , borderRadius : '40px'}} className="card">
                    <div className="card-body">
                        <h4 className="card-title"><i>Thông tin cá nhân</i></h4>
                        <br></br>
                        <form className="form-sample">
                                ...
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <input style={{borderRadius : '30px'}} type="text" value={inputValues.firstName} name="firstName" onChange={(event) => handleOnChange(event)} className="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <input style={{borderRadius : '30px'}} type="text" value={inputValues.lastName} name="lastName" onChange={(event) => handleOnChange(event)} className="form-control" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <input style={{borderRadius : '30px'}} type="text" value={inputValues.address} name="address" onChange={(event) => handleOnChange(event)} className="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <input style={{borderRadius : '30px'}} type="number" value={inputValues.phonenumber} disabled={isActionADD === true ? false : true} name="phonenumber" onChange={(event) => handleOnChange(event)} className="form-control" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <select style={{borderRadius : '30px'}} className="form-control" value={inputValues.genderCode} name="genderCode" onChange={(event) => handleOnChange(event)}>
                                ...
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <DatePicker style={{borderRadius : '30px'}} className="form-control" onChange={handleOnChangeDatePicker}
                                                value={birthday}
                                            />
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <input style={{borderRadius : '30px'}} onChange={(event) => handleOnChangeImage(event)} type="file" className="form-control form-file" />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        <label className="col-sm-3 col-form-label">Ảnh hiển thị</label>
                                        <div className="col-sm-9">
                                            <div style={{ backgroundImage: `url(${inputValues.imageReview})` , borderRadius : '30px' }} onClick={() => openPreviewImage()} className="box-img-preview"></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-9">
                                            <input style={{borderRadius : '30px'}} type="email" value={inputValues.email} name="email" onChange={(event) => handleOnChange(event)} className="form-control" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <button style={{backgroundColor : 'rgb(250 166 26)' , border : '1px solid rgb(250 166 26)'}} type="button" onClick={() => handleSaveUser()} className="btn1 btn1-primary1 btn1-icon-text">
