        ...
        <>
                ...
                <div className="col-md-12 grid-margin">
                    <div className="row">
                        <div className="col-12 col-xl-8 mb-4 mb-xl-0">
                            ...
                            <h3 style={{ textTransform: "uppercase" }} className="font-weight-normal mb-0">Thống Kê Số Lượng Bài Đăng Từng Lĩnh Vực</h3>
                        </div>
            ...
            </div>
            {
                ...
                <div className="col-12 grid-margin">
                    <div style={{padding : '20px' , borderRadius : '30px'}} className="card">
                        <div className="card-body">
                            <h4 className="card-title"><i>Bảng thông kê số lượng CV</i></h4>
            ...
            }
            {
                ...
                <div className="col-12 grid-margin">
                    <div style={{padding : '30px' , borderRadius : '30px'}} className="card">
                        <div className="card-body">
                            <h4 className="card-title"><i>Bảng thống kê doanh thu các gói bài đăng</i></h4>
                            <button  style={{float:'right' , borderRadius : '30px'}} onClick={() => handleOnClickExport('packagePost')} >Xuất excel <i class="fa-solid fa-file-excel"></i></button>
                            <RangePicker style={{borderRadius : '30px'}} onChange={(values)=>onDatePicker(values,'packagePost')}
                                format={'DD/MM/YYYY'}
                            ></RangePicker>


                            <div style={{marginTop : '20px'}} className="table-responsive pt-2">
                                <table className="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th>
                                            ...
                                            dataStatisticalPackagePost.map((item, index) => {
                                                ...
                                                return (
                                                    <tr key={index}>
                                                        ...
                                                        <td>{item.count}</td>
                                                        <td style={{ textAlign: 'right' }}>{(item.total * 1000000).toLocaleString('vi-VN')} VNĐ</td>
                                                    </tr>
                                                )
                                            })
                                        }
                        ...
                        {
                        dataStatisticalPackagePost && dataStatisticalPackagePost.length > 0 &&
                            <div class='mr-4' style={{display:'flex', justifyContent:'end'}}><b>Tổng doanh thu : &nbsp;</b>{(dataSum * 1000000).toLocaleString('vi-VN')} VNĐ</div>
                        }
                        <ReactPaginate
                            previousLabel={'Quay lại'}
                            nextLabel={'Tiếp'}
                ...
                <div className="col-12 grid-margin">
                    <div style={{padding : '30px' , borderRadius : '30px'}} className="card">
                        <div className="card-body">
                            <h4 className="card-title"><i>Bảng thống kê doanh thu các gói mua lượt xem ứng viên</i></h4>
                            <button  style={{float:'right' , borderRadius : '30px'}} onClick={() => handleOnClickExport('packageCv')} >Xuất excel <i class="fa-solid fa-file-excel"></i></button>
                            <RangePicker style={{borderRadius : '30px'}} onChange={(values)=>onDatePicker(values,'packageCv')}
                                format={'DD/MM/YYYY'}
                            ></RangePicker>
                        ...
                        {
                        dataStatisticalPackageCv && dataStatisticalPackageCv.length > 0 &&
                        <div class='mr-4' style={{display:'flex', justifyContent:'end'}}><b>Tổng doanh thu : &nbsp;</b>{(dataSumCv * 1000000).toLocaleString('vi-VN')} VNĐ</div>
                        }
                        <ReactPaginate
                            previousLabel={'Quay lại'}
                            nextLabel={'Tiếp'}
