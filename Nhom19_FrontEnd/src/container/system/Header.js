...
const Header = () => {
    ...
    return (
        <nav style={{zIndex : '100'}} className="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div style={{width : '18.2%'}} className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            ...
            <div style={{width : '81.8%' , backgroundColor : '#ffcc66'}} className="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                ...
                <ul className="navbar-nav navbar-nav-right">
                    ...
                    <li className="nav-item nav-profile dropdown">
                        <a className="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                            <b>{user.firstName + " " + user.lastName + ` ( ${user.roleCode == "EMPLOYER" ? "COMPANY" : user.roleCode} )`}&nbsp;&nbsp;&nbsp;&nbsp;</b>
